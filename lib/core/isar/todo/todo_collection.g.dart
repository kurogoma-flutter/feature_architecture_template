...
extension TodoQueryWhereSort on QueryBuilder<Todo, Todo, QWhere> {
  ...
  QueryBuilder<Todo, Todo, QAfterWhere> anyUpdatedAt() {
    return QueryBuilder.apply(this, (query) {
...
extension TodoQueryWhere on QueryBuilder<Todo, Todo, QWhereClause> {
  ...
  QueryBuilder<Todo, Todo, QAfterWhereClause> updatedAtEqualTo(
      DateTime updatedAt) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Todo, Todo, QAfterWhereClause> updatedAtNotEqualTo(
      DateTime updatedAt) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<Todo, Todo, QAfterWhereClause> updatedAtGreaterThan(
    DateTime updatedAt, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Todo, Todo, QAfterWhereClause> updatedAtLessThan(
    DateTime updatedAt, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Todo, Todo, QAfterWhereClause> updatedAtBetween(
